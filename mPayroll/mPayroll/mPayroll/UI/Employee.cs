    ...
    public partial class frmEmployee : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                printer.Title = "M/S TAS ENTERPRISE";
                printer.SubTitle = "\r\n Employee Record " +
                                   "Print Date : " + DateTime.Now.ToShortDateString();
                ...
                printer.Footer = " Powered By TAS";

                printer.FooterColor = Color.DarkGray;
                printer.SubTitleSpacing = 15;
                printer.FooterSpacing = 15;
                printer.SubTitleColor = Color.LightSlateGray;
                printer.printDocument.DefaultPageSettings.Landscape = true;

                printer.PrintDataGridView(dgvEmp);
            }
        }
